...
def guess_checker(guess, answer):
    global score # Global is used here because the score has been definded outside the function and we want be modifying the score.
    still_guessing =True
    attempt = 0
...
guess_checker(guess1,'Osagyefo Dr. Kwame Nkrumah')
guess2 = input("Which year did Ghana gain independence? \n")
guess_checker(guess2,'1957')
guess3 = input("Which year dd free SHS commence? \n")
guess_checker(guess3,'2017')
